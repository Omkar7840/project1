...
if(isset($_POST['order_btn'])){
   ...
   if($cart_total == 0){
      ...
      if(mysqli_num_rows($order_query) > 0){
         ...
         mysqli_query($conn, "INSERT INTO `orders`(user_id, name, number, email, payment_method, address, total_products, total_price, placed_on) VALUES('$user_id', '$name', '$number', '$email', '$paymaet_method', '$address', '$total_products', '$cart_total', '$placed_on')") or die('query failed');
